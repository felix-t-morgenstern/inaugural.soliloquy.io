...
class LoopingLinearMovingFloatBoxProviderTest extends SpriteRendererTest {
    ...
    protected static void graphicsPreloaderLoadAction() {
        ...
        HashMap<Long, FloatBox> valuesAtTimes = new HashMap<Long, FloatBox>() {{
            put(0L, origin.translate(-translationAmount, -translationAmount));
            put(1000L, origin.translate(translationAmount, -translationAmount));
            put(2000L, origin.translate(translationAmount, translationAmount));
            put(3000L, origin.translate(-translationAmount, translationAmount));
        }};
