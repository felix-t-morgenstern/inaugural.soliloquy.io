...
class FiniteLinearMovingColorProviderImplPausingTest
    ...
    public static void closeAfterSomeTime(GraphicsCoreLoop graphicsCoreLoop) {
        ...
        SpriteRenderable.BorderColorProvider.reportPause(new FakeGlobalClock().globalTimestamp());

        CheckedExceptionWrapper.sleep(2000);

        SpriteRenderable.BorderColorProvider.reportUnpause(new FakeGlobalClock().globalTimestamp());
