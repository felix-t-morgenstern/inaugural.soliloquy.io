...
public class FiniteLinearMovingProviderFactoryImpl implements FiniteLinearMovingProviderFactory {
    ...
    private final Map<String, Function<EntityUuid,Function<Map,
    ...
    public FiniteLinearMovingProviderFactoryImpl(Map<String, Function<EntityUuid,Function<Map,
            Function<Long,Function<Long,FiniteLinearMovingProvider>>>>> factories) {
    ...
    @Override
    public <T> FiniteLinearMovingProvider<T> make(EntityUuid id, Map<Long, T> valuesAtTimestamps,
                                                  Long pausedTimestamp, Long mostRecentTimestamp)
            throws IllegalArgumentException {
        String type = CAN_GET_INTERFACE_NAME
                .getProperTypeName(valuesAtTimestamps.values().iterator().next());
        //noinspection rawtypes
        Function<EntityUuid,Function<Map,Function<Long,Function<Long,FiniteLinearMovingProvider>>>>
