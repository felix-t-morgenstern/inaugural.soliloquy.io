...
public class StaticMouseCursorPreloaderTask implements Runnable {
    ...
    public StaticMouseCursorPreloaderTask(
            Function<String, Long> getMouseCursorByRelativeLocation,
            Collection<StaticMouseCursorDefinitionDTO> staticMouseCursorDefinitionDTOs,
    ...
    public void run() {
        STATIC_MOUSE_CURSOR_DTOS.forEach(staticMouseCursorDefinitionDTO -> PROCESS_RESULT.accept(
                STATIC_MOUSE_CURSOR_PROVIDER_FACTORY.apply(
