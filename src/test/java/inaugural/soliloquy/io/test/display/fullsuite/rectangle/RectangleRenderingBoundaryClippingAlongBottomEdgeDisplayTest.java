package inaugural.soliloquy.io.test.display.fullsuite.rectangle;
...
public class RectangleRenderingBoundaryClippingAlongBottomEdgeDisplayTest extends DisplayTest {
    public static void main(String[] args) {
        var displayTest = new DisplayTest();
        displayTest.runTest(
                "Rectangle clipping along bottom edge display test",
                ...
                () -> DisplayTest.runThenClose("Rectangle clipping along bottom edge", 8000),
                RectangleRenderingBoundaryClippingAlongBottomEdgeDisplayTest::populateTopLevelComponent
        );
    }
        ...
        var dimensProvider = finiteLinearMovingProviderFactory.make(
                ...
                mapOf(
                        pairOf(
                                now,
                                floatBoxOf(
                                        vertexOf(0.25f - squareLength,0.75f - squareLength),
                        ...
                        pairOf(
                                now + 8000,
                                floatBoxOf(
                                        vertexOf(0.75f + squareLength,0.75f - squareLength),
                                        squareLength, squareLength
                                )
                        )
                ),
