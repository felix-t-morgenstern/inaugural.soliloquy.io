...
public class RectangleRenderingBoundaryClippingAlongTopEdgeDisplayTest extends DisplayTest {
    public static void main(String[] args) {
        var displayTest = new DisplayTest();
        displayTest.runTest(
                "Rectangle clipping along top edge display test",
                ...
                () -> DisplayTest.runThenClose("Rectangle clipping along top edge", 8000),
                RectangleRenderingBoundaryClippingAlongTopEdgeDisplayTest::populateTopLevelComponent
        );
    }
        ...
        var dimensProvider = finiteLinearMovingProviderFactory.make(
                ...
                mapOf(
                        pairOf(
                                now,
                                floatBoxOf(
                                        vertexOf(0.25f - squareLength,0.25f),
                        ...
                        pairOf(
                                now + 8000,
                                floatBoxOf(
                                        vertexOf(0.75f + squareLength,0.25f),
                                        squareLength, squareLength
                                )
                        )
                ),
