...
public class RectangleRenderingBoundaryClippingAlongRightEdgeDisplayTest extends DisplayTest {
    public static void main(String[] args) {
        var displayTest = new DisplayTest();
        displayTest.runTest(
                "Rectangle clipping along right edge display test",
                ...
                () -> DisplayTest.runThenClose("Rectangle clipping along right edge", 8000),
                RectangleRenderingBoundaryClippingAlongRightEdgeDisplayTest::populateTopLevelComponent
        );
    }
        ...
        var dimensProvider = finiteLinearMovingProviderFactory.make(
                ...
                mapOf(
                        pairOf(
                                now,
                                floatBoxOf(
                                        vertexOf(0.75f - squareLength,0.75f),
                        ...
                        pairOf(
                                now + 8000,
                                floatBoxOf(
                                        vertexOf(0.75f - squareLength,0.25f - squareLength),
                                        squareLength, squareLength
                                )
                        )
                ),
