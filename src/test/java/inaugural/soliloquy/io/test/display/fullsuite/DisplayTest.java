...
public class DisplayTest {
    ...
    protected final static String DISPLAY_TEST_MUSIC_ID = "displayTestMusicId";
    ...
    public void runTest(
            String testName,
            AssetDefinitionsDTO assetDefinitionsDTO,
            java.util.function.Consumer<IOModule> displayTest,
            BiConsumer<IOModule, Component> populateTopLevelComponent
    ) {
        ...
        ioModule = new IOModule(
                ...
                mapOf(
                        ...
                        RELEASE_SOUND_ID,
                        "Kevin_MacLeod_-_Living_Voyage.mp3",
