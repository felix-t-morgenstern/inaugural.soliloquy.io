package inaugural.soliloquy.io.test.display.mockedsetup;
    ...
    protected static void runTest(Function<WindowResolutionManager, Set<Renderer>>
        ...
        var coreLoop =
                new CoreLoopImpl("My title bar", FrameTimer, 0, windowResolutionManager,
                        ...
                        mapOf(), mapOf(), mapOf(), mock(SoundsPlaying.class), (_, _) -> {},
                        mock(KeyEventListener.class), MockMouse::updateCursor,
                        MockMouse::setMostRecentMouseLocation,
