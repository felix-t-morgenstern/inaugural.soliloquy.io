...
public class RectangleRenderingBoundaryClippingAlongLeftEdgeDisplayTest extends DisplayTest {
    public static void main(String[] args) {
        var displayTest = new DisplayTest();
        displayTest.runTest(
                "Rectangle clipping along left edge display test",
                ...
                () -> DisplayTest.runThenClose("Rectangle clipping along left edge", 8000),
                RectangleRenderingBoundaryClippingAlongLeftEdgeDisplayTest::populateTopLevelComponent
        );
    }
        ...
        var dimensProvider = finiteLinearMovingProviderFactory.make(
                ...
                mapOf(
                        ...
                        pairOf(
                                now + 8000,
                                floatBoxOf(
                                        vertexOf(0.25f,0.25f - squareLength),
                                        squareLength, squareLength
                                )
                        )
                ),
