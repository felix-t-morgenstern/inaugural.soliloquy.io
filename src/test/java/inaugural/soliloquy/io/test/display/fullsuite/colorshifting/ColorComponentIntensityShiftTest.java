package inaugural.soliloquy.io.test.display.fullsuite.colorshifting;

import inaugural.soliloquy.io.IOModule;
import inaugural.soliloquy.io.test.display.fullsuite.DisplayTest;
import inaugural.soliloquy.io.test.display.fullsuite.sprite.SpriteSimpleDisplayTest;
...
public class ColorComponentIntensityShiftTest extends SpriteSimpleDisplayTest {
    public static void main(String[] args) {
        var displayTest = new DisplayTest();
        displayTest.runTest(
                "Color component intensity shift display test",
                ASSET_DTOS,
                () -> DisplayTest.runThenClose("Color component intensity shift", 4000),
                ColorComponentIntensityShiftTest::populateTopLevelComponent
        );
    }
