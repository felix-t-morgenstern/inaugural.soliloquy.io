package inaugural.soliloquy.io.test.display.mockedsetup.providers.looping.linear.floatbox;
...
import inaugural.soliloquy.io.test.display.mockedsetup.rendering.renderers.spriterenderer.SpriteRendererTest;
...
class LoopingLinearMovingFloatBoxProviderTest extends SpriteRendererTest {
    ...
    protected static void graphicsPreloaderLoadAction() {
        ...
        var floatBoxStart = floatBoxOf(0.375f, 0.3125f, 0.625f, 0.6875f);
        var translationAmount = 0.25f;
        var valuesAtTimes = mapOf(
            pairOf(0, translateFloatBox(floatBoxStart, -translationAmount, -translationAmount)),
            pairOf(1000, translateFloatBox(floatBoxStart, translationAmount, -translationAmount)),
            pairOf(2000, translateFloatBox(floatBoxStart, translationAmount, translationAmount)),
            pairOf(3000, translateFloatBox(floatBoxStart, -translationAmount, translationAmount))
        );
