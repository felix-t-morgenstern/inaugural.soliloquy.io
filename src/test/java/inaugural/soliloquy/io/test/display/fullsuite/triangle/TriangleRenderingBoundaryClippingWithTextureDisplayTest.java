package inaugural.soliloquy.io.test.display.fullsuite.triangle;
...
public class TriangleRenderingBoundaryClippingWithTextureDisplayTest extends DisplayTest {
    public static void main(String[] args) {
        var displayTest = new DisplayTest();
        displayTest.runTest(
                "Triangle clipping with texture display test",
                ...
                () -> DisplayTest.runThenClose("Triangle clipping with texture", 8000),
                TriangleRenderingBoundaryClippingWithTextureDisplayTest::populateTopLevelComponent
        );
    }
