package inaugural.soliloquy.io.test.display.mockedsetup.rendering.renderers.spriterenderer;
...
public class SpriteRendererTest extends DisplayTest {
    ...
    public static Set<Renderer> generateRenderablesAndRenderersWithMeshAndShader(
        ...
        lenient().when(MockFirstChildComponent.contentsRepresentation()).thenReturn(setOf(SpriteRenderable));
