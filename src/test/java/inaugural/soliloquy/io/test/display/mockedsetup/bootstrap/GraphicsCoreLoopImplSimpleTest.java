package inaugural.soliloquy.io.test.display.mockedsetup.bootstrap;
    ...
    public static void main(String[] args) {
        ...
        var coreLoop =
                new CoreLoopImpl("New window",
                        ...
                        mock(SoundsPlaying.class), (_, _) -> {}, mock(KeyEventListener.class),
                        mock(Consumer.class), mock(Consumer.class), mock(TriConsumer.class));
