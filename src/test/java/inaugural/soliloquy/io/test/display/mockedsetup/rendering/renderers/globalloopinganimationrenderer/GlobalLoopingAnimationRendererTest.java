package inaugural.soliloquy.io.test.display.mockedsetup.rendering.renderers.globalloopinganimationrenderer;
...
class GlobalLoopingAnimationRendererTest extends DisplayTest {
    ...
    protected static void graphicsPreloaderLoadAction() {
        ...
        when(MockFirstChildComponent.contentsRepresentation()).thenReturn(setOf(GlobalLoopingAnimationRenderable));
