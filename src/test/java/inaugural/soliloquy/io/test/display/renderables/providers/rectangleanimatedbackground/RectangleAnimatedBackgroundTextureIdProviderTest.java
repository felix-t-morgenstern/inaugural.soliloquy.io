package inaugural.soliloquy.io.test.display.renderables.providers.rectangleanimatedbackground;
...
public class RectangleAnimatedBackgroundTextureIdProviderTest extends DisplayTest {
    ...
    protected static void graphicsPreloaderLoadAction() {
        ...
        RectangleRenderable = new RectangleRenderableImpl(TOP_LEFT_COLOR_PROVIDER,
                ...
                RectangleAnimatedBackgroundTextureIdProvider, staticProvider(BACKGROUND_TEXTURE_TILE_WIDTH),
