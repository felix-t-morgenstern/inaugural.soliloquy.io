...
public class SpriteFactoryTests {
    ...
    private Function<SpriteDefinition, Sprite> spriteFactory;
    ...
    public void testCreate() {
        ...
        var createdSprite = spriteFactory.apply(definition);
    ...
    public void testCreateWithInvalidArgs() {
        assertThrows(IllegalArgumentException.class, () -> spriteFactory.apply(null));

        assertThrows(IllegalArgumentException.class, () -> spriteFactory.apply(
